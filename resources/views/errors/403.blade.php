...
<body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-0">Anda tidak mempunyai akses untuk menggunakan fitur ini, Hubungi Administrator Aplikasi Anda.</p>
                            </div>
    ...
    <footer class="footer footer-alt">
        2015 - <script>document.write(new Date().getFullYear())</script> &copy;  <a href="" class="text-white-50">Fintek Mutiara Indonesia</a> 
    </footer>
