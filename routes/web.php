...
Route::middleware([
    ...
    Route::get('/role/{role}', [App\Http\Controllers\RoleController::class, 'edit'])->name('roles.edit');
    ...
    Route::get('/permission/{permission}', [App\Http\Controllers\PermissionController::class, 'edit'])->name('permission.edit');
